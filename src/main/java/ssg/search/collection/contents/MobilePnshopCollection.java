...
public class MobilePnshopCollection implements Collection, Prefixable, Pageable{
	...
	public Call<Info> getPage(){
		return new Call<Info>(){
			public Info apply(Parameter parameter){
				...
				} else if (strTarget.equalsIgnoreCase("mobile_omni_all")) {	//mobile_omni_all 경우 최대 100개까지 내려준다
					strPage  = "1";
					strCount = "100";
				}
