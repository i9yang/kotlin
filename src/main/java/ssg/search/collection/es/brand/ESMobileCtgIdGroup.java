...
public class ESMobileCtgIdGroup extends ESCollection implements Groupable {
	@Override
	public String getCollectionAliasName(Parameter parameter) {
		return "ESMobileCtgIdGroup";
	}
	...
	public Result getResult(SearchResult searchResult, String name, Parameter parameter, Result result) {
		...
		result.setBrandCategoryList(ResultUtils.getMobileBrandCategoryGroup(parameter.getSiteNo(), parameter.getCtgId(), Joiner.on("@").join(ctgLst)));
		return result;
	}
}
