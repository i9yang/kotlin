...
public class MobileBrandDispCollection implements Collection, Prefixable, Groupable{
	...
	public Result getResult(Search search, String name, Parameter parameter, Result result){
		...
		if(!ctgLst.equals("")){
	        result.setBrandCategoryList(ResultUtils.getMobileBrandCategoryGroup(parameter.getSiteNo(),  parameter.getCtgId(), ctgLst));
		}
		return result;
	}
